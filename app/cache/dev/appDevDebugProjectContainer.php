...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'free_ads', 'user' => 'root', 'password' => 'T24oNqFc', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_c2e1c877acec388906ecb36b76927fd6');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c2e1c877acec388906ecb36b76927fd6');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c2e1c877acec388906ecb36b76927fd6');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Freeads\\FreeadsBundle/Resources/views'), 'FreeadsFreeads');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FreeadsFreeadsBundle' => 'Freeads\\FreeadsBundle\\FreeadsFreeadsBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'free_ads',
            'database_user' => 'root',
            'database_password' => 'T24oNqFc',
